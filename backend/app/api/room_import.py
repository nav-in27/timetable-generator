"""
API endpoints for bulk Room Excel/CSV import.
"""
...
router = APIRouter(prefix="/rooms/import", tags=["Room Import"])
...
async def download_template():
    template_bytes = RoomImportService.generate_template()
