"""
API endpoints for bulk Department Excel/CSV import.
"""
...
from app.services.department_import_service import DepartmentImportService

router = APIRouter(prefix="/departments/import", tags=["Department Import"])
...
async def upload_and_validate(
    ...
    service = DepartmentImportService(db)
...
async def download_template():
    template_bytes = DepartmentImportService.generate_template()
